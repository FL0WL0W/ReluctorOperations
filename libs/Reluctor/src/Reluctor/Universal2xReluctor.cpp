...
// 		_config = config;
// 		_pin = _config->Pin;
// 		_hardwareAbstractionCollection->DigitalService->ScheduleRecurringInterrupt(_config->Pin, new HardwareAbstraction::CallBack<Universal2xReluctor>(this, &Universal2xReluctor::InterruptCallBack));
// 		_isSynced = false;
// 		_lastTick = 0;
// 		_period   = 0;
// 		_state	  = false;
...
// 	void Universal2xReluctor::InterruptCallBack()
// 	{
// 		_state = _digitalService->ReadPin(_pin);
